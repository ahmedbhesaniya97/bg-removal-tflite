...
function useTFLite(segmentationConfig: SegmentationConfig) {
  console.log("** TF SegmentationConfig", segmentationConfig);
  ...
  useEffect(() => {
    async function loadTFLite() {
      ...
      try {
        ...
        console.log("** TF loadTFLite try", createdTFLiteSIMD);
      } catch (error) {
  ...
  useEffect(() => {
    async function loadTFLiteModel() {
      console.log("** TF loadTFLiteModel ");
